...
public class HeaderTest extends BaseTest {
	...
	@Test
	public void verifyUserisAbleToSeeHeaders() {
		
		List<String> expectedHeaders=new ArrayList<>(List.of("books","computers","electronics","apparel & shoes","digital downloads","jewelry","gift cards"));
